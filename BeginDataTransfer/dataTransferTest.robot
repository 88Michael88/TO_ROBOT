...
*** Test Cases ***
TC 01 - TCP Transfer at Minimum Speed
...
TC 04 - TCP Transfer at High Speed
...
TC 07 - TCP Transfer Above Max Speed
...
TC 19 - Missing Bearer at Low Speed
    [Documentation]     Verify that data transfer fails when Bearer ID is not registered. Expect HTTP 400 error.
    [Setup]             Prepare Test Environment Without Bearer
    Set Transfer Speed To 1 kbps
    Set TCP Protocol
...
TC 20 - Missing Bearer at High Speed
    [Documentation]     Verify that data transfer fails when Bearer ID is not registered. Expect HTTP 400 error.
    [Setup]             Prepare Test Environment Without Bearer
    Set Transfer Speed To 1 Mbps
    Set TCP Protocol
...
TC 22 - Transfer below Minimum Speed 
