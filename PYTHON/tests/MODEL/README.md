...
|-|-|-|-
| test_attach_request_accepts_valid_range | 
| test_attach_request_rejects_invalid_range | 
| test_add_bearer_accepts_valid_range | 
| test_add_bearer_rejects_invalid_range | 
| test_bearer_config_defaults | 
| test_bearer_config_accepts_valid_protocol | 
| test_bearer_config_rejects_invalid_protocol | 
| test_ue_state_initializes_empty_dicts | 
| test_ue_state_converts_none_to_empty_dicts | 
| test_start_traffic_target_bps | 
| test_start_traffic_requires_exactly_one_throughput | 
| test_start_traffic_requires_at_least_one_throughput | 
| test_start_traffic_rejects_invalid_protocol | 
