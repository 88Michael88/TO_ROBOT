*** Settings ***
Documentation    This suite contains test cases for Stop Data Transfer and Reset functionality of the simulator. Resource         Resources/SetupTeardownWithArguments.resource
Library          Collections
